...
const lines = [
  ...
  "",
  "## Mission",
  "The Friendship Practice translates the social science of adult connection into concrete, repeatable action. So that better friendships stop being an intention and start being a practice.",
  "",
  "## Offer",
  seo.llms.offer,
  "",
